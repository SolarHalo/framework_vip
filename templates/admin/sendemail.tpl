...
$(function () {
    jQuery("#list2").jqGrid({
   	url:'{{$smarty.const.WEBSITE_URL}}admin/email/emailLogs',
...
jQuery("#list2").jqGrid('navButtonAdd','#pager2',{
                    ...
                    onClickButton : function () { 
                        ...
                        //window.location.href = "{{$smarty.const.WEBSITE_URL}}admin/userLog/exportExcel";
                   		window.location.href = "{{$smarty.const.WEBSITE_URL}}service/admin/exportemaillog.php?"+condition;
                    } 
                });
}); 

function gridReload(){
	jQuery("#list2").jqGrid('setGridParam',{url:"{{$smarty.const.WEBSITE_URL}}admin/email/emailLogs/"+getTimeCondition(),page:1}).trigger("reloadGrid");
}
